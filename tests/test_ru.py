...
в.-луж., н.-луж. strona, полабск. stárna"
            ...
            [
                ...
                "лист бумаги в составе книги, газеты и т. п.. (Пример: Мне захотелось вырвать страницу, чтоб этого \
страшного никогда не случилось)",
                "<i>(Комп.)</i> отдельный документ в составе интернет-сайта",
                "<i>(П.)</i> очередной этап в развитии чего-либо. (Пример: Голографический микроскоп откроет новую \
<i>(Выдел)</i> в исследовании живых клеток.)",
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "страна, из церк.-слав. страна, далее из праслав.\xa0*storna, от кот. в числе прочего произошли: \
др.-русск. сторона, ст.-слав. страна (др.-греч. χώρα, περίχωρος), русск., укр. сторона́, болг. \
страна́, сербохорв. стра́на (вин. стра̑ну), словенск. strána, чешск., словацк. strana, польск. \
strona, в.-луж., н.-луж. strona, полабск. stárna",
        ),
    ],
)
