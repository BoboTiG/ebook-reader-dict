    ...
    [
        (
            ...
            [
                ...
                "лист бумаги в составе книги, газеты и\xa0т.\xa0п.. (Пример: Мне захотелось вырвать страницу, чтоб этого страшного никогда не случилось)",
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "страна, из церк.-слав. страна, далее из праслав.\xa0*storna, от кот. в числе прочего произошли: др.-русск. сторона, ст.-слав. страна (др.-греч. χώρα, περίχωρος), русск., укр. сторона́, болг. страна́, сербохорв. стра́на (вин. стра̑ну), словенск. strána, чешск., словацк. strana, польск. strona, в.-луж., н.-луж. strona, полабск. stárna",
        ),
    ],
)
