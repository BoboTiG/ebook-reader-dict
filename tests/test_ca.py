    ...
    [
        ...
        (
            ...
            [
                ...
                "<i>(occidental, balear)</i> <i>Primera persona del singular (jo) del present subjunctiu del verb</i> <b>comptar</b>",
                "<i>(occidental, balear)</i> <i>Tercera persona del singular (ell, ella, vostè) del present subjunctiu del verb</i> <b>comptar</b>",
        ...
        (
            ...
            [],
            [],
            ["<i>Forma plural de</i> <b>experta</b>"],
            ["experta"],
        ),
        ("halloweeniana", [], [], [], ["<i>Forma femenina de</i> <b>halloweenià</b>"], ["halloweenià"]),
        (
            "hivernacle",
            [],
            ["m"],
