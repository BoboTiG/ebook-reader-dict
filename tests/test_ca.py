    ...
    [
        ...
        (
            ...
            [
                ...
                "<i>(balear, alguerès)</i> <i>Primera persona del singular (jo) del present d'indicatiu de</i> <b>botar</b>",
                "<i>Tercera persona del singular (ell, ella, vostè) del present d'indicatiu de</i> <b>botre</b>",
        ...
        (
            ...
            [
                ...
                "cap a",
                "<i>Primera persona del singular (jo) del present d'indicatiu de</i> <b>cabre</b>",
                "<i>Tercera persona del singular (ell, ella, vostè) del present d'indicatiu de</i> <b>cabre</b>",
                "<i>Segona persona del singular (tu) de l'imperatiu del verb</i> <b>cabre</b>",
                "<i>(balear)</i> <i>Primera persona del singular (jo) del present d'indicatiu de</i> <b>capar</b>",
            ],
            ["cabre", "capar"],
        ),
        (
            ...
            [
                ...
                "<i>(balear, alguerès)</i> <i>Primera persona del singular (jo) del present d'indicatiu de</i> <b>casar</b>",
            ],
            ["ca", "casar"],
        ),
        (
        ...
        (
            ...
            [
                ...
                "atenció",
                "<i>(valencià)</i> <i>Primera persona del singular (jo) del present d'indicatiu de</i> <b>comptar</b>",
                "<i>(occidental, balear)</i> <i>Primera persona del singular (jo) del present subjuntiu del verb</i> <b>comptar</b>",
                "<i>(occidental, balear)</i> <i>Tercera persona del singular (ell, ella, vostè) del present subjuntiu del verb</i> <b>comptar</b>",
                "<i>(occidental, balear)</i> <i>Tercera persona del singular (ell, ella, vostè) de l'imperatiu del verb</i> <b>comptar</b>",
            ],
            ["comptar"],
        ),
        (
        ...
        (
            ...
            [
                ...
                "<i>(obsolet)</i> <i>Format alternativa de</i> <b>ela</b>",
            ],
            [],
        ),
        (
            ...
            [],
            [],
            ["<i>Format plural de</i> <b>experta</b>"],
            ["experta"],
        ),
        ("halloweeniana", [], [], [], ["<i>Format femenina de</i> <b>halloweenià</b>"], ["halloweenià"]),
        (
            "hivernacle",
            [],
            ["m"],
        ...
        (
            ...
            [],
            [
                "<i>(balear, alguerès)</i> <i>Primera persona del singular (jo) del present d'indicatiu de</i> <b>penar</b>"
            ],
            ["penar"],
        ),
        (
